...
./bas.py --auto --ident=node2 --whatwho --begin=CLT --dest=CLT < /tmp/in2a > /tmp/out2a &
./clt.py --auto --ident=node2 --whatwho --begin=BAS < /tmp/in2b > /tmp/out2b &

./bas.py --auto --ident=node3 --whatwho --begin=CLT --dest=CLT < /tmp/in3a > /tmp/out3a &
./clt.py --auto --ident=node3 --whatwho --begin=BAS < /tmp/in3b > /tmp/out3b &
