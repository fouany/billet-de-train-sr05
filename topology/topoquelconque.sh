...
# Noeud 1
./gch.py --auto --nb-sites=6 --appname=CLT --ident=gch --whatwho --bas-dest=NET < ./tmp/in1c > ./tmp/out1c &
...
cat ./tmp/out2n | tee ./tmp/in2c > ./tmp/in5n &

# CLT2 -> CLT1
cat ./tmp/out3c > ./tmp/in3n &
cat ./tmp/out3n | tee ./tmp/in3c > ./tmp/in2n &

# CLT3 -> CLT2 et CLT3 -> CLT5
cat ./tmp/out4c > ./tmp/in4n &
cat ./tmp/out4n | tee ./tmp/in4c > ./tmp/in6n ./tmp/in3n &
...
cat ./tmp/out6n | tee ./tmp/in6c > ./tmp/in5n ./tmp/in1n &
